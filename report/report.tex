...
human players are collected from the Microban website. \textbf{Please cite the Microban website!!}. 
...
The benchmark is the best player score in Microban website (\textbf{citeme!!!}).



\subsection{Plan quality analysis}

The diagram in \textbf{Figure 1} illustrates how the solution given by the 
...
unable to give any solution for problems 10 and 11 when provided with 10 
pliers. A plausible explanation is illustrated in in \textbf{Figure 2} and 
\textbf{Figure 3}. 
